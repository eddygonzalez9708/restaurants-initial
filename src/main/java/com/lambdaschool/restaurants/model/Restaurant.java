...
public class Restaurant extends Auditable
{
    ...
    @Size(min = 2, max = 2, message = "State is the two character state")
    private String state;

    @Pattern(regexp = "\\d{3}-\\d{3}-\\d{4}", message = "555-555-555")
    private String telephone;

    @Email(message = "Email should be a valid username@domain.toplevel")
